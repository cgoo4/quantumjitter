...
[Lua Filters](https://quarto.org/docs/extensions/filters.html) are a powerful tool. The `_quarto.yml` file includes one to check my current installed version of Quarto and then insert that into the website's page-footer.
