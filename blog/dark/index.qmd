...
[Lua Filters](https://quarto.org/docs/extensions/filters.html) are a powerful tool. The `_quarto.yml` file includes one to check my current installed version of Quarto and then insert that into the website's page-footer[^1].

[^1]: Suggested solution in [Stack Overflow](https://stackoverflow.com/questions/74734849/quarto-installed-version-in-website-page-footer)
