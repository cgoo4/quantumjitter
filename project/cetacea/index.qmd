...
I'd like to also make use of the textrecipes[@textrecipes] package. I can tokenise the textual information in `comment` and `location` to see if these add to the predictive power of the model.
